...
public class StreamToVersionedTableJoin extends BaseTopologyBuilder {

    private static final Logger log = LoggerFactory.getLogger(StreamToVersionedTableJoin.class);

    private static final String OUTPUT_TOPIC = "stream-to-versioned-table-join-output";
    ...
    protected void build(StreamsBuilder builder) {
        ...
        final Materialized<String, OSProcess, KeyValueStore<Bytes, byte[]>> processStore =
                Materialized.as(
        ...
        builder.<String, OSWindow>stream(
                ...
                .join(
                        processes,
                        StreamToVersionedTableJoin::asString,
