...
public class WebServer {
  ...
  public WebServer(int port, int webSocketPort, String applicationId, Topology topology, KafkaStreams kafkaStreams, Map<String, String> metadata, Map<String, String> producerMetadata) throws IOException {
    ...
    httpServer.createContext("/port", new PortHandler(applicationId, webSocketPort));
